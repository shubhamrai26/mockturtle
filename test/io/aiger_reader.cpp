...
TEST_CASE( "read and write names", "[aiger_reader]" )
{
  ...
  CHECK( named_aig.get_name( named_aig.make_signal( named_aig.pi_at( 0 ) ) ) == "x0" );
  CHECK( named_aig.get_name( named_aig.make_signal( named_aig.pi_at( 1 ) ) ) == "x1" );
...
TEST_CASE( "read an ASCII Aiger file into an AIG network and store input-output names", "[aiger_reader]" )
{
  ...
  CHECK( named_aig.get_name( named_aig.make_signal( named_aig.pi_at( 0 ) ) ) == "foo" );
  CHECK( named_aig.get_name( named_aig.make_signal( named_aig.pi_at( 1 ) ) ) == "bar" );
